define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "q",
            "description": "<p>(status) Text filter for data (N/A)</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "q",
            "description": "<p>(type) Text filter for data (N/A)</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "q",
            "description": "<p>(lid, subcategory_id, title, status) Text filter for data (N/A)</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "GET",
    "url": "/v1/auth/labresult/getrelate",
    "title": "Get product related to requirement",
    "version": "1.0.0",
    "name": "getRelate",
    "group": "LabResult",
    "permission": [
    ...
    "description": "<p>Get 3 product related to requirement</p>",
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:3000/v1/auth/labresult/getrelate",
        "type": "json"
      }
    ],
    "success": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "profileId",
            "description": "<p>ID of profile, on query</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "resultId",
            "description": "<p>ID of result, on query</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
            "optional": false,
            "field": "Note",
            "description": "<p>Not use profileId and resultId in the same time</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "GET",
    "url": "/v1/auth/matching/getrequest",
    "title": "Get Request",
    "version": "1.0.0",
    "name": "getRequest",
    "group": "Matching",
    ...
    "description": "<p>Get all Request that lab receive or company sent</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "lid",
            "description": "<p>ID of lab, on query</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": false,
            "field": "cid",
            "description": "<p>ID of company, on query</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
            "optional": false,
            "field": "Note",
            "description": "<p>Not use lid and cid in the same time</p>"
          }
        ]
      }
    },
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:3000/v1/auth/matching/getrequest?cid=4\ncurl -i http://localhost:3000/v1/auth/matching/getrequest?lid=5",
        "type": "json"
      }
    ],
    "success": {
        ...
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "step",
            "description": "<p>1: waiting for accept <br/> 2: Accept (call the client, choose date to meeting) <br/> 3: organize the meeting <br/> 4: waiting for accept agreement <br/> 5: contract <br/> 6: support <br/> 7: Done <br/> 8: Pending <br/> 9: Canceled <br/> 10: Rejected <br/> 11: Accept the meeting <br/> 11: Scheduled the meeting <br/> 13: Contracting editing</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
          ...
          },
          {
            ...
            "description": "<p>Scheduled the meeting Address</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
            "optional": true,
            "field": "meetingTime",
            "description": "<p>Scheduled the meeting Time</p>"
          },
          {
            "group": "Parameter",
            "type": "file",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "file",
            "description": "<p>banner's image</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "q",
            "description": "<p>(title, description, category_id, begin, status) Text filter for data (N/A)</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "q",
            "description": "<p>(cid, subcategory_id, title, status) Text filter for data (N/A)</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "GET",
    "url": "/v1/auth/profile/getrelate",
    "title": "Get requirement related to product",
    "version": "1.0.0",
    "name": "getRelate",
    "group": "Profile",
    "permission": [
    ...
    "description": "<p>Get 3 requirement related to product</p>",
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:3000/v1/auth/profile/getrelate",
        "type": "json"
      }
    ],
    "success": {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "q",
            "description": "<p>(type, name, taxcode) Text filter for data (N/A)</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "q",
            "description": "<p>(email, type, status) Text filter for data (N/A)</p>"
          }
        ]
      }
    },
